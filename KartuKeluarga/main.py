...
def crateKKWithBoundingBox(pathImg,pathBB):
    posK = (2960, 32)
    posNo = (1470,215)
    posNKK = (715,317)
    posAlamat = (715,375)
    ...
    listBoundingBox = [[(1115,70), (2520,60),(2520, 190), (1115,200), "KARTU KELUARGA"],  
                    ...
                    #    [(585, 650), (655, 650), (655, 700), (585, 700), "( 1 )"],
                    [(1156, 574), (1240, 574), (1240, 626), (1156, 626), "NIK"],
                    #    [(1156, 650), (1240, 650), (1240, 700), (1156, 700), "( 2 )"],
                    ...
                    [(744, 2204), (1015, 2204), (1015, 2246), (744, 2246), "IV.Kecamatan"],
...
#--------------------------------------------------------------
    ...
    createKKComplete(pathImg)
    writeBBToTxt(pathBB,listBoundingBox)
...
n=5
for i in range(n):
    pathImg = "result/" + str(i+1) + ".png"
    pathBB = "result/" + str(i+1) + ".txt"
    crateKKWithBoundingBox(pathImg,pathBB)
    print(i)
